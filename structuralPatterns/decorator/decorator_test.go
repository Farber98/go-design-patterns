...
func TestPizzaDecorator_AddIngredient(t *testing.T) {
	...
	if !strings.Contains(pizzaResult, expectedText) {
		t.Errorf("When calling the add ingredient of the pizza decorator it must return the text %s", expectedText)
	}
}
...
func TestOnion_AddIngredient(t *testing.T) {
	...
	if !strings.Contains(onionResult, "onion") {
		t.Errorf("When calling AddIngredient of the onion decorator it must return a text with the word onion, not %s", onionResult)
	}
}
...
func TestMeat_AddIngredient(t *testing.T) {
	...
	if !strings.Contains(meatResult, "meat") {
		t.Errorf("When calling AddIngredient of the meat decorator it must return a text with the word meat, not %s", meatResult)
	}
}
...
func TestPizzaDecorator_FullStack(t *testing.T) {
	...
	if !strings.Contains(pizzaResult, expectedText) {
		t.Errorf("When asking for a pizza with onion and meat the returned string must contain the text %s but %s didnt have it", expectedText, pizzaResult)
	}
	t.Log(pizzaResult)
}
